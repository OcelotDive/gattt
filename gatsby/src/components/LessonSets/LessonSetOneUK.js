...
class LessonSetOneUK extends Component {
    ...
    render() {
        ...
        return (
			...
			<div className="lessonContainer" id="lessonDiv">
			<h5 className="lessonTitle" id="Lesson3" data-keys="KeyF,KeyG,KeyH,KeyJ,KeyA,KeyS,KeyD,KeyK,KeyL,Semicolon,Space">LESSON 3</h5>
